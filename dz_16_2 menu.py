...
def menu():
    ...
    print("")
    print("\033[32m==========Menu=========\033[0m")
    print("Введите команду:")
    
    # print("\033[33mgen_turtle\033[0m - сгенерировать координаты черепашки на поле")
    # print("\033[33mdestination\033[0m - сгенерировать координаты точки назначения на поле")
    # print("\033[33mway_count\033[0m - посчитать количество ходов черепашки до точки назначения")
    
    print("\033[33mgt\033[0m - сгенерировать координаты черепашки на поле")
    print("\033[33mdes\033[0m - сгенерировать координаты точки назначения на поле")
    print("\033[33mwc\033[0m - посчитать количество ходов черепашки до точки назначения")

    print("\033[1;31mstop\033[0m - завершить работу программы")
...
while True:
    ...
    if command.lower() == "stop":
        ...
        break
    elif command.lower() == "gt":
        print("")
        gen_turtle()
    elif command.lower() == "des":
        print("")
        destination()
    elif command.lower() == "wc":
        print("")
        way_count()
    else:
        print("")
